...
; module containing definitions
.include "module\define.asm"

; module containing the RAM map
.include "module\ram.asm"

; module for handling VBlank
.include "module\vblank.asm"
